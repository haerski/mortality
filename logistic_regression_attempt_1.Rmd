...
reg_2_tune <- reg_2_workflow %>%
  tune_grid(reg_val, grid=reg_penalty, metrics=metric_set(sens, spec, ppv, npv, bal_accuracy, detection_prevalence))
reg_2_tune
```
