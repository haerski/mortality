...
other_data <-
  ...
  select(zip3, POP, AREALAND, `Deaths involving COVID-19`, per_dem, `Social Vulnerability Index (SVI)`, `CVAC level of concern for vaccination rollout`, `less than high school`, `Unemployment_rate_2019`, `PCTPOVALL_2019`  ) %>%
