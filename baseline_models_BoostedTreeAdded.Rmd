...
xgb_spec <- boost_tree(
  ...
  loss_reduction = 1.76047836572171e-10,                     ## first three: model complexity
  sample_size = 0.883587669710218, mtry = 5,         ## randomness
  learn_rate = 8.5485672736443e-10,                         ## step size
) %>% 
  set_engine("xgboost") %>% 
  set_mode("classification")
...
#  min_n = 4
#  tree_depth = 5
#  learn_rate = 8.5485672736443e-10
#  loss_reduction = 1.76047836572171e-10
#  sample_size = 0.883587669710218
