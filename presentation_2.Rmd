...
clients %>%
  ...
  guides(color = FALSE) + labs(title = "Size of Actual claims")+
  scale_color_manual(values=c("yellow3","deepskyblue", "black"))
...
TODO before knitting, remove the verbose option
